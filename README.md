...
2. Checkout into the res389-assignment1 branch
3. Install dependencies: `pip install -r requirements.txt`
4. Run the streamlit app: API_KEY="[my_specific_api_key]" streamlit run chat_with_pdf.py

# Accepted Files
You can upload .txt, .pdf, and .html (or .htm) files. There is no limit of how many files you can upload, but the maximum size is 200 mb per file.
...
# Chunking strategy
Each chunk is 800 characters NOT tokens, and the chunks overlap by 100 characters to preserve some context. They are also separated by natural English punctuation (i.e. paragraphs, sentences, words). 
